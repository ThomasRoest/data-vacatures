  ...
  function EpicEditor(options) {
    ...
    var self = this
      ...
      , defaults = { container: 'epiceditor'
        , basePath: '/assets'
        , textarea: 'parsed_markdown'
        , clientSideStorage: true
        , localStorageName: 'epiceditor'
        , useNativeFullscreen: true
        , file: { name: null
        , defaultContent: ''
          , autoSave: 100 // Set to 100 or false for no auto saving
          }
        , theme: { base: '/epiceditor-007d25266f95c4c4763104e45d0250a1.css'
          , preview: '/epic-preview-e0aff694a961c6534b7d85313a6ac2a4.css'
          , editor: '/epic-light-73f2f2aa23524cdac27f967a9f357936.css'
          }
        , focusOnLoad: false
