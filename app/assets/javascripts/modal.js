...
//       $modal = $('<div class="modal modal-markdownoptions"/>'),         // Create markup for modal
//       $content = $('<div class="modal-content"/>'),
//       $close = $('<div class="center btn-modal"><button role="button" class="btn btn-small btn-primary">Ok</button></div>');
...
//         // width: settings.width || 'auto',           // removed, set width with css
//         // height: settings.height || 'auto'          // removed, set height in css
